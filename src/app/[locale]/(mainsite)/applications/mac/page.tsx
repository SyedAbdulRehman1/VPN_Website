...
import MacAppStore from "@/img/MacOs-AppStore.svg";
import MacSecurity from "@/img/Mac-Security.png";
import LocationAccess from "@/img/LocationAccess.png";
          ...
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            <div className="">
              ...
              <div className="mt-7 grid gap-5 w-full place-items-center sm:inline-flex justify-center">
                ...
                <a href={links["MacOS"]?.link} target="_blank">
                  <Image
                    className=""
                    src={MacAppStore.src}
                    width={165}
          ...
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            <div className="flex flex-col justify-center py-4 lg:order-2">
              <h1 className="mb-4 text-2xl lg:text-4xl tracking-tight font-bold text-gray-darkf dark:text-white canela-regular">
                {t("AccessHeading")} <Prominent>{t("AnywhereText")} </Prominent>
              </h1>
        ...
        <section>
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            <div className="flex flex-col justify-center py-4">
              <h1 className="mb-4 text-2xl lg:text-4xl tracking-tight font-bold text-gray-darkf dark:text-white canela-regular">
                {t("EnsureText")} <Prominent>{t("SecureText")}</Prominent> on
                public networks.
              </h1>
              <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                {t("EnsureParagraph")}
